...
<div class="event-carousel">
  <div class="carousel-track-wrapper">
    <div class="carousel-track">
      ...
      <div class="event-slide" data-images='["/img/gallery/Emmenhof_Elias.jpeg", "/img/gallery/IMG_9154.jpeg"]'>
        <div class="event-slide-image">
          <img src="/img/gallery/Emmenhof_Elias.jpeg" alt="Emmenhof Areal, Derendingen" loading="lazy">
        </div>
        <div class="event-slide-title">Emmenhof Areal, Derendingen</div>
      </div>
    </div>
  </div>
  <button class="carousel-btn carousel-prev" aria-label="Previous event">&#8592;</button>
  <button class="carousel-btn carousel-next" aria-label="Next event">&#8594;</button>
  <div class="carousel-dots"></div>
</div>
